  ...
  return (
    <>
      ...
      <div className="persona-rail">
        <div>
          <Typography variant="overline" sx={{ letterSpacing: ".18em", color: "#e9b45d" }}>PORTFOLIO / PROFILE 01</Typography>
        ...
        <nav aria-label="Primary navigation" className="flex flex-col gap-3">
          <button className="bg-amber-100 text-blue-950 p-3 font-bold hover:bg-red-500 font-mono" onClick={() => setMenu(true)}>
            [MENU]
          </button>
        </nav>
      </div>
      <nav aria-label="Primary navigation" className="mobile-menu hidden gap-3 fixed bottom-10 right-10 z-10 font-mono">
        <button className="bg-amber-100 text-blue-950 p-3 font-bold hover:bg-red-500" onClick={() => setMenu(true)}>
          [MENU]
        </button>
      </nav>
    </>
