...
export default function PortfolioContentComponent() {
  ...
  return (
    <div className='fade-in max-w-screen sm:p-20 font-(family-name:--font-geist-sans) overflow-x-clip'>
      ...
      <div className='about about-bg fixed top-0 left-0 h-screen min-w-screen md:p-10 z-500 sm:p-0 sm:pl-0'>
        <Item>
          <AboutComponent />
        </Item>
        <ArrowDownwardIcon className='right-1/2 bottom-0 fixed animate-bounce' />
      </div>
      <div className='experience exp-bg fixed top-0 left-0 h-screen min-w-screen bg-radial-[at_75%_75%] from-red-500 via-red-700 to-red-950 p-10 z-400'>
        <Item>
          <ExperienceComponent />
        </Item>
      </div>
      <div className='tech tech-bg fixed top-0 left-0 h-screen min-w-screen bg-radial-[at_75%_25%] from-blue-500 via-blue-700 to-blue-950 p-5 z-300'>
      ...
      <div className='contact contact-bg block my-auto h-screen min-w-screen fixed top-0 left-0 bg-radial-[at_50%_50%] from-indigo-500 via-indigo-700 to-indigo-950  z-200'>
      ...
      <div className='projects fixed top-0 left-0'>
